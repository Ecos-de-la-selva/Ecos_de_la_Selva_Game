...
func _ready():
	...
	await mostrar_dialogo_y_esperar([
		"Que hermosa Fauna, las aves",
		"¡Sabías que en el Putumayo hay casi 1,000 especies de aves!",
		"Eso es casi la mitad de todas las aves que existen en Colombia.",
		"¡Cuidar nuestro entorno es proteger", 
		"este paraíso de plumas y cantos!"
	])
